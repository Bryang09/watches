    ...
    .filter(
      ...
      res =>
          ...
          props.kors && props.one && props.silver ? res.brand === "Michael Kors" && res.price2 < 201 && res.color === "silver" :
           // BRAND MK |  COLOR IS BLACK | PRICE < 201
          props.kors && props.one && props.black ? res.brand === "Michael Kors" && res.price2 < 201 && res.color === "black" :
           // BRAND MK |  COLOR IS GOLD | PRICE < 201
          ...
          props.kors && props.two && props.silver ? res.brand === "Michael Kors" && res.price2 > 200 && res.price2 < 301 && res.color === "silver" :
           // BRAND MK |  COLOR IS BLACK | PRICE 200 - 300
          props.kors && props.two && props.black ? res.brand === "Michael Kors" && res.price2 > 200 && res.price2 < 301 && res.color === "black":
          ...
          props.kors && props.three && props.silver ? res.brand === "Michael Kors" && res.price2 > 300 && res.price2 < 401 && res.color === "silver":
           // BRAND MK |  COLOR IS BLACK | PRICE 300 - 400
          props.kors && props.three && props.black ? res.brand === "Michael Kors" && res.price2 > 200 && res.price2 < 401 && res.color === "black" :
           //  BRAND MK  | PRICE < 201
          props.kors && props.one ? res.brand === "Michael Kors" && res.price2 < 201 :
          ...
          props.kors && props.silver ? res.brand === "Michael Kors" && res.color === "silver" :
           //  BRAND MK  | BLACK
          props.kors && props.black ? res.brand === "Michael Kors" && res.color === "black" :
          //  BRNAD MK
